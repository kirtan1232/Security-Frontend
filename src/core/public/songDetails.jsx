  ...
  useEffect(() => {
    ...
    if (autoScroll && lyricsRef.current) {
      scrollInterval = setInterval(() => {
        if (
          lyricsRef.current.scrollTop + lyricsRef.current.clientHeight <
          lyricsRef.current.scrollHeight
        ) {
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900">
      ...
      <main className="flex-1 p-6 flex justify-center items-start mt-4 relative z-10">
        <div className="bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-700/50 p-8 w-full max-w-7xl h-[85vh] flex flex-col relative overflow-y-auto">
          ...
          <h2 className="text-xl font-semibold mt-4 text-gray-200">
            Chord Diagrams:
          </h2>
          ...
          <div
            ref={lyricsRef}
            className="flex-1 overflow-y-auto p-2 bg-gray-700 rounded-lg custom-scrollbar"
          >
