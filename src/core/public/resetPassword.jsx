    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (
                ...
                errorMsg.toLowerCase().includes("please use another password") ||
                errorMsg.toLowerCase().includes("old password")
            ) {
                toast.error("Please Use another password.", {
                    position: "top-right",
                    autoClose: 3000,
                });
            } else {
                ...
                <div className="w-1/2 bg-gradient-to-br from-indigo-800 via-purple-800 to-indigo-900 flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-200 text-lg">Create a strong new password</p>
                        </div>
                    </div>
                </div>
            </div>
