...
const Sidebar = () => {
  ...
  return (
    <div className="min-h-screen flex">
      <aside
        className={`bg-gray-800/90 backdrop-blur-xl shadow-2xl rounded-3xl relative transition-all duration-300 border border-gray-700/50 flex flex-col ${
          isCollapsed ? "w-20 ml-2 mt-2 mb-2" : "w-72 ml-4 mt-6 mb-7"
          ...
          <ul className="space-y-1 pb-4">
            ...
            <li>
              ...
              >
                ...
                {!isCollapsed && (
                  <span className="ml-3 font-medium text-sm">Lessons</span>
                )}
              </Link>
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                {!isCollapsed && (
                  <span className="ml-3 font-medium text-sm">Tuner</span>
                )}
              </Link>
            </li>
            <li>
              ...
              >
                ...
                {!isCollapsed && (
                  <span className="ml-3 font-medium text-sm">Liked Songs</span>
                )}
              </Link>
            </li>
            <li>
              ...
              >
                ...
                {!isCollapsed && (
                  <span className="ml-3 font-medium text-sm">Support Us</span>
                )}
              </button>
            </li>
            {isAdmin && (
